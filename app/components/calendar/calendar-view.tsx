  ...
  const fetchDrills = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setDrills([
          { id: '1', name: 'Free Throw Practice', category: 'shooting', description: 'Practice free throws', duration: '300', skillLevel: 'BEGINNER', equipment: 'Basketball', stepByStep: ['Stand at free throw line', 'Aim for the rim', 'Shoot with proper form'], coachingTips: ['Keep your elbow aligned'], isPublic: true, userId: 'mock-user' },
          { id: '2', name: 'Dribbling Drills', category: 'dribbling', description: 'Basic dribbling exercises', duration: '600', skillLevel: 'BEGINNER', equipment: 'Basketball', stepByStep: ['Start with stationary dribbling', 'Practice with both hands', 'Increase speed gradually'], coachingTips: ['Keep your head up'], isPublic: true, userId: 'mock-user' },
          { id: '3', name: 'Defensive Stance', category: 'defense', description: 'Practice defensive positioning', duration: '450', skillLevel: 'BEGINNER', equipment: 'None', stepByStep: ['Wide stance', 'Bend knees', 'Keep arms active'], coachingTips: ['Stay low and balanced'], isPublic: true, userId: 'mock-user' },
          { id: '4', name: 'Layup Practice', category: 'shooting', description: 'Practice layups from both sides', duration: '900', skillLevel: 'INTERMEDIATE', equipment: 'Basketball', stepByStep: ['Approach at angle', 'Use proper footwork', 'Soft touch on backboard'], coachingTips: ['Use the backboard'], isPublic: true, userId: 'mock-user' },
          { id: '5', name: 'Passing Drills', category: 'passing', description: 'Various passing techniques', duration: '720', skillLevel: 'BEGINNER', equipment: 'Basketball', stepByStep: ['Chest pass', 'Bounce pass', 'Overhead pass'], coachingTips: ['Step into the pass'], isPublic: true, userId: 'mock-user' },
        ]);
      }
    } catch (error) {
